...
//		final Integration details = new Integration();
//		com.epam.ta.reportportal.entity.project.Project p = new com.epam.ta.reportportal.entity.project.Project();
//		p.setName("forConnectionTest");
//		details.setProject(p);
//
//		IntegrationParams params = new IntegrationParams(new HashMap<>());
//		details.setParams(params);
//		JiraProps.USER_NAME.setParam(params, "user");
//		JiraProps.AUTH_TYPE.setParam(params, "BASIC");
//		JiraProps.PASSWORD.setParam(params, "password");
//		JiraProps.URL.setParam(params, "https://jira.epam.com");
//
//		Assert.assertTrue(jiraStrategy.connectionTest(details));
//		details.getProject().setName("notExist");
//		Assert.assertFalse(jiraStrategy.connectionTest(details));
//		details.getProject().setName("exception");
//		Assert.assertFalse(jiraStrategy.connectionTest(details));
//
//		JiraProps.AUTH_TYPE.setParam(details.getParams(), "BASIC");
//		thrown.expect(ReportPortalException.class);
//		thrown.expectMessage(formattedSupplier(UNABLE_INTERACT_WITH_EXTRERNAL_SYSTEM.getDescription(),
//				"AccessKey value cannot be NULL"
//		).get());
//		jiraStrategy.connectionTest(details);
//
//	}
//
//	@Test
//	public void getTicketTest() {
//		final Integration system = new Integration();
//		IntegrationParams params = new IntegrationParams(new HashMap<>());
//		system.setParams(params);
//		JiraProps.USER_NAME.setParam(params, "user");
//		JiraProps.AUTH_TYPE.setParam(params, "BASIC");
//		JiraProps.PASSWORD.setParam(params, "password");
//		JiraProps.URL.setParam(params, "https://jira.epam.com");
...
//		IntegrationParams params = new IntegrationParams(new HashMap<>());
//		system.setParams(params);
//		JiraProps.PROJECT.setParam(params, "project1");
//		com.epam.ta.reportportal.entity.project.Project p = new com.epam.ta.reportportal.entity.project.Project();
//		p.setName("project1");
//		JiraProps.URL.setParam(params, "https://jira.epam.com");
//
//		final List<PostFormField> ticketFields = jiraStrategy.getTicketFields("BUG", system);
...
//				OptionalIterable<IssueType> issueTypes = new OptionalIterable<>(singletonList(new IssueType(null,
//						1L,
//						"BUG",
//						false,
//						null,
...
//						singletonList(new BasicComponent(null, 10001L, "Debug Component", "Debug")),
//						issueTypes,
//						singletonList(new ProjectRole(1L,
//								null,
//								"Developers",
//								null,
...
//
//				when(cimProject.claim()).thenReturn(singletonList(new CimProject(null,
//						"Bug",
//						null,
//						null,
//						null,
...
//				new CimFieldInfo("fixVersions", false, "Fix Version/s", new FieldSchema("array", null, null, null, null), null, null, null)
//		);
//		fields.put("versions",
//				new CimFieldInfo("versions", false, "Affects Version/s", new FieldSchema("array", null, null, null, null), null, null, null)
//		);
//		fields.put("priority", new CimFieldInfo("priority",
//				false,
//				"Priority",
//				new FieldSchema("priority", null, null, null, null),
//				null,
//				singletonList(new BasicPriority(null, 1L, "Blocker")),
//				null
//		));
...
//				new CimFieldInfo("customAssignee1",
//						false,
//						"CustomAssignee1",
//						new FieldSchema("user", null, null, null, 1L),
//						null,
//						null,
//						null
//				)
...
//				new CimFieldInfo("description",
//						false,
//						"Description",
//						new FieldSchema("string", null, "description", null, null),
//						null,
//						null,
//						null
//				)
...
//				new CimFieldInfo("customArrayField1",
//						false,
//						"CustomArrayField1",
//						new FieldSchema("array", null, null, null, 1L),
//						null,
//						null,
//						null
//				)
//		);
//		fields.put("customArrayField2", new CimFieldInfo("customArrayField2",
//				false,
//				"CustomArrayField2",
//				new FieldSchema("array", null, null, null, 1L),
//				null,
//				singletonList(new CustomFieldOption(1L, null, null, null, null)),
//				null
//		));
...
//				new CimFieldInfo("customNumberField1",
//						false,
//						"CustomNumberField1",
//						new FieldSchema("number", null, null, null, 1L),
//						null,
//						null,
//						null
//				)
//		);
//		fields.put("customComponentField1", new CimFieldInfo("customComponentField1",
//				false,
//				"customComponentField1",
//				new FieldSchema("string", null, null, null, 1L),
//				null,
//				singletonList(new CustomFieldOption(1L, null, null, null, null)),
//				null
//		));
...
//				new CimFieldInfo("timetracking",
//						false,
//						"Time Tracking",
//						new FieldSchema("timetracking", null, null, null, 1L),
//						null,
//						null,
//						null
//				)
